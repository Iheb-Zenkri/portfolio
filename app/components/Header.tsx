  ...
  return (
    ...
    items-center justify-center gap-4'>
        <motion.div initial={{scale : 0}} whileInView={{scale : 1}} transition={{duration: 0.8, type: 'spring', stiffness: 100}}>
            <Image src={assets.profileImage} alt='' 
        ...
        Innovative software engineer driven by problem-solving, efficiency, 
        and scalability, committed to building impactful and future-ready solutions.
        </motion.p>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            href='/Iheb Zenkri resume.pdf' download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2
