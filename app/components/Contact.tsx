...
const Contact = () => {
    ...
    const onSubmit = async (event: React.FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        const form = event.currentTarget; // Ensures correct typing
        const formData = new FormData(form);
      
        formData.append("access_key", "9551d7a6-1590-4d74-afbd-753c089815f9");
  ...
  return (
    ...
    bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            className='w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-16
             dark:bg-darkHover/30 dark:border-white/90'/>
            ...
            dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'>
                Submit now <Image src={assets.rightArrowWhite} alt='' className='w-4'/></button>
